...
def write_private_target(
	...
	environment_content = (
		...
		f"PLE_WORKER_S3_ACCESS_KEY_ID={secrets.token_hex(16)}\n"
		f"PLE_WORKER_S3_SECRET_ACCESS_KEY={secrets.token_hex(32)}\n"
		...
		f"PLE_BROWSER_ORIGIN=https://localhost:{ports.gateway}\n"

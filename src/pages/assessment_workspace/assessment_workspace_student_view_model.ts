...
import type { StudentAssessmentPresentationData } from "../../components/student_assessment_presentation";

export const STUDENT_VIEW_CUE =
  "Student view - current live assessment. Use Student entry to submit graded work.";
export const STUDENT_VIEW_ENTRY_PATH = "/sign-in";

export type StudentViewState =
  | { readonly kind: "loading" }
  | { readonly kind: "ready"; readonly assessment: StudentAssessmentPresentationData }

...
.editor-grid { display:grid; gap:1rem; grid-template-columns:minmax(0, 1fr) minmax(18rem, .7fr); }
.editor-panel { padding:1rem; border:1px solid var(--ple-border); border-radius:.5rem; background:var(--ple-surface); box-shadow:none; }
.editor-panel h2 { margin-top:0; }
.editor-field { display:grid; gap:.4rem; margin:1rem 0; font-weight:720; }
.editor-field input, .editor-field textarea, .editor-field select { width:100%; min-height:2.75rem; padding:.55rem .65rem; border:1px solid var(--ple-border); border-radius:.375rem; background:var(--ple-surface); color:var(--ple-ink); }
.editor-field textarea { min-height:8rem; resize:vertical; }
.editor-actions { display:flex; flex-wrap:wrap; gap:.6rem; align-items:center; margin-top:.85rem; }
...
.editor-draft-list button { width:100%; min-height:2.75rem; padding:.55rem .65rem; border:1px solid var(--ple-border); border-radius:.375rem; background:var(--ple-surface); color:var(--ple-ink); text-align:left; }

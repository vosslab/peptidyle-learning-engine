...
.qti-profile-import > summary { display:flex; flex-wrap:wrap; gap:.4rem .7rem; align-items:baseline; min-height:2.75rem; padding:.55rem 0; cursor:pointer; font-weight:780; }
...
.qti-profile-import__field input[type="file"] { width:100%; min-width:0; min-height:2.75rem; padding:.45rem .55rem; border:1px solid var(--ple-border); border-radius:.375rem; background:var(--ple-surface-soft); color:var(--ple-ink); font:inherit; }
.qti-profile-import__field-help { margin:0; color:var(--ple-muted); font-size:.9rem; font-weight:500; overflow-wrap:anywhere; }
.qti-profile-import__actions { display:flex; flex-wrap:wrap; gap:.55rem; align-items:center; }

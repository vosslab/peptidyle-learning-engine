...
.qti-profile-import { min-width:0; border:1px solid var(--ple-border); border-radius:.85rem; background:var(--ple-surface); }
.qti-profile-import > summary { display:flex; flex-wrap:wrap; gap:.45rem .8rem; align-items:baseline; padding:.9rem 1rem; cursor:pointer; font-weight:780; }
...
.qti-profile-import__body { display:grid; gap:1rem; min-width:0; padding:0 1rem 1rem; border-top:1px solid var(--ple-border); }
.qti-profile-import__intro { margin:.9rem 0 0; color:var(--ple-muted); }
.qti-profile-import__archive-context { margin:0; padding:.65rem .75rem; border:1px solid var(--ple-border); border-radius:.55rem; background:var(--ple-surface-soft); overflow-wrap:anywhere; }
.qti-profile-import__field { display:grid; gap:.4rem; min-width:0; font-weight:700; }
.qti-profile-import__field input[type="file"] { width:100%; min-width:0; padding:.65rem; border:1px solid var(--ple-border); border-radius:.55rem; background:var(--ple-surface-soft); color:var(--ple-ink); font:inherit; }
.qti-profile-import__field-help { margin:0; color:var(--ple-muted); font-size:.9rem; font-weight:500; overflow-wrap:anywhere; }
.qti-profile-import__actions { display:flex; flex-wrap:wrap; gap:.6rem; align-items:center; }
...
.qti-profile-import__report { display:grid; gap:1rem; min-width:0; }
.qti-profile-import__report h2, .qti-profile-import__report h3 { margin-bottom:.35rem; }
.qti-profile-import__profile { display:grid; grid-template-columns:repeat(3, minmax(0, 1fr)); gap:.65rem; margin:0; }
.qti-profile-import__profile div { min-width:0; padding:.65rem; border:1px solid var(--ple-border); border-radius:.6rem; background:var(--ple-surface-soft); }
...
.qti-profile-import__items { display:grid; gap:.75rem; margin:0; padding:0; list-style:none; }
.qti-profile-import__item { min-width:0; padding:.8rem; border:1px solid var(--ple-border); border-radius:.7rem; background:var(--ple-surface-soft); overflow-wrap:anywhere; }
...
.qti-profile-import__review { display:grid; gap:.65rem; padding:.8rem; border:1px solid var(--ple-border); border-radius:.7rem; background:var(--ple-surface-soft); }

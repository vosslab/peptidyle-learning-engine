// question_json_policy_fields.tsx - explicit scoring, retry, and timing policy controls.
...
export interface PleQuestionJsonPolicyFieldsProps {
  ...
  readonly onQuestionAttemptLimitChange: (limit: PleQuestionJsonAttemptLimit) => void;
  readonly onQuestionAttemptTimeLimitChange: (policy: PleQuestionJsonAttemptTimeLimit) => void;
...
function isTimingKind(value: string): value is PleQuestionJsonAttemptTimeLimit["kind"] {
  return value === "unlimited" || value === "limited";
}

/** Retry and timing edits use native controls and keep unlimited attempts reversible. */
export function PleQuestionJsonPolicyFields(props: PleQuestionJsonPolicyFieldsProps): JSX.Element {
  const timingKind = (): PleQuestionJsonAttemptTimeLimit["kind"] =>
  ...
  const setTimingKind = (kind: PleQuestionJsonAttemptTimeLimit["kind"]): void => {
    if (kind === "unlimited") {
    ...
    <fieldset>
      ...
      <div class="ple-question-json-authoring__grid">
        <label class="ple-question-json-authoring__field">
          ...
          <input
            ...
            aria-describedby={
              error("points")() === undefined ? undefined : "ple-question-json-points-error"
            }
            onInput={(event) =>
        ...
        <label class="ple-question-json-authoring__field">
          ...
          <input
            ...
            aria-describedby={
              error("questionAttemptLimit.maxAttempts")() === undefined
                ? undefined
                : "ple-question-json-attempts-error"
            }
            onInput={(event) =>
          ...
          />
          <small class="ple-question-json-authoring__help">
      ...
      <Show when={error("points")() !== undefined}>
        <p
          ...
          id="ple-question-json-points-error"
          role="alert"
        >
          {error("points")()}
        </p>
      ...
      <Show when={error("questionAttemptLimit.maxAttempts")() !== undefined}>
        <p
          class="ple-question-json-authoring__error"
          id="ple-question-json-attempts-error"
          role="alert"
        >

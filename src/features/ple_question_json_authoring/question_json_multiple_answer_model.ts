// question_json_multiple_answer_model.ts - identity-preserving private edits for multiple-answer choices.
...
function changed(response: PleQuestionJsonMultipleAnswerResponse): MultipleAnswerEditResult {
...
function choiceAt(
  response: PleQuestionJsonMultipleAnswerResponse,
  choiceId: string,
): PleQuestionJsonChoice | undefined {

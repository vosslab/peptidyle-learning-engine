// question_json_fill_in_model.ts - private authoring operations for one accepted text response.
...
export type PleQuestionJsonFillInValidation = {
...
export function validateFillInResponse(
  response: PleQuestionJsonFillInResponse,
): PleQuestionJsonFillInValidation {
...
export function addFillInAnswer(
  response: PleQuestionJsonFillInResponse,
): PleQuestionJsonFillInResponse {

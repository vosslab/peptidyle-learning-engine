// question_json_numeric_model.ts - private authoring validation for numeric responses.
...
export type PleQuestionJsonNumericValidation = {
...
export function validateNumericResponse(
  ...
  tolerance: PleQuestionJsonNumericResponseTolerance,
  unit: string | null,
): PleQuestionJsonNumericValidation {
...
export function setNumericResponseToleranceKind(
  kind: PleQuestionJsonNumericResponseTolerance["kind"],
): PleQuestionJsonNumericResponseTolerance {
  switch (kind) {
    case "exact":
      return { kind };
...
export function numericResponseFromAuthoring(
  response: PleQuestionJsonNumericResponse,
  answerLiteral: string,
  tolerance: PleQuestionJsonNumericResponseTolerance,
  unit: string | null,
): PleQuestionJsonNumericResponse | null {

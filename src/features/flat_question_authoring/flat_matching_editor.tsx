// flat_matching_editor.tsx - compact private controls for semantic MATCH pairs.

import { For, Index, Show, type JSX } from "solid-js";

import type { FlatQuestionItem, FlatQuestionMatch } from "./flat_question_source";

export interface FlatMatchingEditorProps {
  ...
  return (
    <fieldset class="flat-question-authoring__matching">
      ...
      <div class="flat-question-authoring__grid">
        <section aria-labelledby="flat-match-prompts-heading">
          <h3 id="flat-match-prompts-heading">Prompts</h3>
        ...
        <section aria-labelledby="flat-match-choices-heading">
          <h3 id="flat-match-choices-heading">Choices</h3>
      ...
      <section aria-labelledby="flat-match-pairing-heading">
        <h3 id="flat-match-pairing-heading">Private pairing check</h3>
        <p class="flat-question-authoring__help">

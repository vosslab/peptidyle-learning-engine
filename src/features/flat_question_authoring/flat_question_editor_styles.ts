...
.flat-question-authoring__field input:not([type="checkbox"]):not([type="radio"]), .flat-question-authoring__field textarea, .flat-question-authoring__field select { width:100%; min-width:0; min-height:2.75rem; padding:.5rem .6rem; border:1px solid var(--ple-border); border-radius:.375rem; background:var(--ple-surface); color:var(--ple-ink); font:inherit; }
...
.flat-question-authoring__choice-list, .flat-question-authoring__taxonomy-list { display:grid; gap:.65rem; margin:0; padding:0; list-style:none; }
.flat-question-authoring__choice, .flat-question-authoring__taxonomy-row { min-width:0; padding:.7rem .8rem; border:0; border-inline-start:3px solid var(--ple-border); border-radius:0; background:var(--ple-surface-soft); }
...
.flat-question-authoring__preview-choice { display:flex; gap:.6rem; align-items:flex-start; min-height:2.75rem; margin:0; padding:.55rem 0; border:0; border-bottom:1px solid var(--ple-border); border-radius:0; }

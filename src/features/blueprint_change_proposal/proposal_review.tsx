    ...
    try {
      ...
      const result = await props.client.acceptBlueprintChangeProposal(
        props.detail.proposal.proposalId,
        {
          ...
          expectedTargetMetadataEtag: props.detail.proposal.targetMetadataEtag,
          decision,
        },
      );
      setCommitted(result);
          ...
          {(side) => {
            ...
            return (
              <section>
                ...
                <p>
                  Short name: {value().names.shortName}. Blueprint {value().revision.reference};
                  frozen Revision {value().revision.revision}; metadata {value().metadataEtag}.
                </p>
...
function AcceptedResult(props: {
  ...
  return (
    <section aria-label="Committed acceptance result">
      ...
      <p>
        Blueprint {props.value.target.reference}, Revision {props.value.target.revision}, metadata{" "}
        {props.value.targetMetadataEtag}; accepted {props.value.acceptedAt}. Decision:{" "}

...
import { decodeAssignmentEditorInput, decodeCourseAppearanceUpdate } from "../decoders";
...
function createMockCourseAppearanceState(): MockCourseAppearanceState {
  return {
    appearances: new Map([
...
async function respondCourse(
  ...
  if (
    resource === "courses" &&
    segments[2] === secondaryMockCourse.id &&

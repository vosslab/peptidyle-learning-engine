// Strict decoder for the Rust-owned Student Assessment decision summary.
...
const START_DECISIONS = [
  ...
  "late_work_refused",
] as const satisfies ReadonlyArray<AssessmentStartDecision>;
 ...
 */
export function decodeStudentAssessmentDecision(
  value: unknown,
  path: string,
): StudentAssessmentDecisionSummary {
  ...
  if (
    ...
    throw new DecodeError(path, "an ordered Assessment schedule");
  }
  return {
    availableAt,
    dueAt,

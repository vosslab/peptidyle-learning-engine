...
SET LOCAL ROLE ple_private_owner;
COMMENT ON COLUMN ple_private.job.lease_token IS 'NULL means this optional fact is absent. Shared work-lease pair with lease_expires_at.';
COMMENT ON COLUMN ple_private.job.lease_expires_at IS 'NULL means this optional fact is absent. Shared work-lease pair with lease_token.';

...
REVOKE ALL ON FUNCTION
    ...
    ple_data.append_assessment_question_pool_fork_revision(text, uuid, bigint, bigint, text[], integer[], boolean)
    FROM PUBLIC;
...
REVOKE ALL ON FUNCTION ple_api.append_assessment_question_pool_fork_revision(text, uuid, bigint, bigint, text[], integer[], boolean) FROM PUBLIC;

GRANT EXECUTE ON FUNCTION ple_api.append_assessment_question_pool_fork_revision(text, uuid, bigint, bigint, text[], integer[], boolean) TO ple_app;

REVOKE ALL ON FUNCTION ple_api.append_assessment_question_pool_fork_revision_for_reference(text, text, uuid, bigint, bigint, text[], integer[], boolean) FROM PUBLIC;

GRANT EXECUTE ON FUNCTION ple_api.append_assessment_question_pool_fork_revision_for_reference(text, text, uuid, bigint, bigint, text[], integer[], boolean) TO ple_app;

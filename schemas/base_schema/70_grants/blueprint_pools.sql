...
GRANT EXECUTE ON FUNCTION ple_data.fork_question_pool(text, text),
...
REVOKE ALL ON FUNCTION ple_api.fork_blueprint_question_pool(text, text),
    ple_api.blueprint_pool_members(text, uuid, text, boolean, bigint, bigint),
    ple_api.append_blueprint_pool_members(text, uuid, bigint, text, bigint, text[], integer[], boolean) FROM PUBLIC;

GRANT EXECUTE ON FUNCTION ple_api.fork_blueprint_question_pool(text, text),
    ple_api.blueprint_pool_members(text, uuid, text, boolean, bigint, bigint),
    ple_api.append_blueprint_pool_members(text, uuid, bigint, text, bigint, text[], integer[], boolean) TO ple_app;

...
GRANT EXECUTE ON FUNCTION ple_data.fork_question_pool_revision(text, text, bigint),
    ple_data.append_question_pool_revision(text, uuid, text[], integer[], boolean) TO ple_api_owner;
...
REVOKE ALL ON FUNCTION ple_api.fork_blueprint_question_pool(text, bigint, text, text),
...
GRANT EXECUTE ON FUNCTION ple_api.fork_blueprint_question_pool(text, bigint, text, text),
    ple_api.blueprint_pool_members(text, uuid, text, boolean, bigint, bigint),

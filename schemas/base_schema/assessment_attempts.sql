...
CREATE TABLE ple_private.assessment_attempt (
    ...
    assessment_navigation_rule text NOT NULL CHECK (assessment_navigation_rule IN ('free_navigation', 'forward_only')),
    assessment_question_order_rule text NOT NULL CHECK (assessment_question_order_rule IN ('authored_order', 'shuffled')),
    feedback_score text NOT NULL CHECK (feedback_score IN ('during_assessment_attempt', 'after_submit', 'after_due', 'after_close', 'never')),
    feedback_per_item_correctness text NOT NULL CHECK (feedback_per_item_correctness IN ('during_assessment_attempt', 'after_submit', 'after_due', 'after_close', 'never')),
    feedback_submitted_response text NOT NULL CHECK (feedback_submitted_response IN ('during_assessment_attempt', 'after_submit', 'after_due', 'after_close', 'never')),
    feedback_question_feedback text NOT NULL CHECK (feedback_question_feedback IN ('during_assessment_attempt', 'after_submit', 'after_due', 'after_close', 'never')),
    feedback_question_answer text NOT NULL CHECK (feedback_question_answer IN ('during_assessment_attempt', 'after_submit', 'after_due', 'after_close', 'never')),
    feedback_question_answer_explanation text NOT NULL CHECK (feedback_question_answer_explanation IN ('during_assessment_attempt', 'after_submit', 'after_due', 'after_close', 'never')),
    feedback_class_statistics text NOT NULL CHECK (feedback_class_statistics IN ('during_assessment_attempt', 'after_submit', 'after_due', 'after_close', 'never')),

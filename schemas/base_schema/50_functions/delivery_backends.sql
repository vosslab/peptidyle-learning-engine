...
BEGIN
    IF ROW(NEW.imathas_question_backend_session_id, NEW.course_instance_id, NEW.assessment_id, NEW.question_attempt_id, NEW.account_id, NEW.imathas_deployment_reference, NEW.imathas_item_reference, NEW.published_question_id, NEW.revision_number, NEW.source_object_record_id, NEW.source_object_checksum, NEW.imathas_profile, NEW.question_seed, NEW.imathas_launch_binding_checksum, NEW.imathas_response_sha256, NEW.imathas_question_backend_session_challenge, NEW.imathas_question_backend_session_authentication, NEW.issued_at, NEW.expires_at, NEW.imathas_question_backend_state_key_id, NEW.imathas_question_backend_state_nonce, NEW.imathas_question_backend_state_ciphertext)
       IS DISTINCT FROM ROW(OLD.imathas_question_backend_session_id, OLD.course_instance_id, OLD.assessment_id, OLD.question_attempt_id, OLD.account_id, OLD.imathas_deployment_reference, OLD.imathas_item_reference, OLD.published_question_id, OLD.revision_number, OLD.source_object_record_id, OLD.source_object_checksum, OLD.imathas_profile, OLD.question_seed, OLD.imathas_launch_binding_checksum, OLD.imathas_response_sha256, OLD.imathas_question_backend_session_challenge, OLD.imathas_question_backend_session_authentication, OLD.issued_at, OLD.expires_at, OLD.imathas_question_backend_state_key_id, OLD.imathas_question_backend_state_nonce, OLD.imathas_question_backend_state_ciphertext) THEN

...
COMMENT ON TABLE ple_audit.assessment_unrelease_event IS
    'Redacted completed Assessment Unrelease audit evidence: actor, Assessment, aggregate counts, and time only.';

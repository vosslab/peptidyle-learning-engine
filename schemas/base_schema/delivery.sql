...
SET search_path = pg_catalog, ple_api, ple_data, ple_private AS $$
DECLARE assessment_attempt ple_private.question_attempt%ROWTYPE;
BEGIN
...
BEGIN
    ...
    IF NOT FOUND THEN RAISE EXCEPTION USING ERRCODE = '42501', MESSAGE = 'iMathAS Session is unavailable'; END IF;
    PERFORM ple_private.require_owned_open_question_attempt(session_course_id, session_assessment_id, p_question_attempt_id);

...
BEGIN
    WITH input AS (
        SELECT publication.key AS slug,
               ...
               publication.value -> 'publishedQuestionRevisionTuple' ->> 'publishedQuestionId' AS published_question_id,
               (publication.value -> 'publishedQuestionRevisionTuple' ->> 'revisionNumber')::integer AS revision_number
          FROM jsonb_each(

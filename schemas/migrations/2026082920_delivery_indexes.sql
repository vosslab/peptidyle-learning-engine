...
CREATE INDEX question_revision_question_description_search_idx
    ON ple_data.question_revision
    USING gin (to_tsvector('simple', question_description));
...
SELECT versions.question_id, versions.revision_number, versions.backend, versions.published_at,
       versions.question_description, versions.public_metadata

...
CREATE INDEX course_retention_cleanup_manifest_object_idx ON public.course_retention_cleanup_manifest_object USING btree (tenant_id, course_id, generation, stage, object_id);

CREATE INDEX course_retention_dispatch_job_idx ON public.course_retention_dispatch USING btree (job_id);

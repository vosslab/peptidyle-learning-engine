-- WP-PROF-G1 / G1-W7: forward accepted-submission completion receipt writer.
--
...
CREATE OR REPLACE FUNCTION public.ple_commit_accepted_submission_completion_v2(
...
BEGIN
    ...
    -- Prove the frozen 36-input authority surface and closed non-owner ACL without

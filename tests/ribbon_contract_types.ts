...
const paramsWithProjection = { courseInstanceId: "CI7K3M2QAZ", courseProjection: { id: "1" } };
...
const paramsWithSessionData = { courseInstanceId: "CI7K3M2QAZ", sessionData: { token: "secret" } };

...
INSERT INTO public.problem_version
    (problem_id, version_id, content_sha256, workspace_id,
     title, backend, metadata, publication_scope, author_ids, public_byline, response_family)
VALUES
    ('11111111-1111-4111-8111-0000000000b6',
     ...
     'public', '["11111111-1111-4111-8111-0000000000b3"]', ARRAY['Flat grading fixture'], 'multipleChoice'),
    ('11111111-1111-4111-8111-0000000000b8',

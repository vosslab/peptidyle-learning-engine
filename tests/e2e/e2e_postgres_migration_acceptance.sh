...
psql_in_container "$BOOTSTRAP_USER" -d "$DATABASE_NAME" < "$repository_root/tests/e2e/postgres_migration_acceptance_assignment_create_compatibility.sql"
echo "PostgreSQL Migration Acceptance Runtime E2E: M4 Assignment-create compatibility oracle PASS"
psql_in_container "$BOOTSTRAP_USER" -d "$DATABASE_NAME" < "$repository_root/tests/e2e/postgres_migration_acceptance_assignment_selection_compatibility.sql"
echo "PostgreSQL Migration Acceptance Runtime E2E: M4 Assignment-selection compatibility oracle PASS"
psql_in_container "$BOOTSTRAP_USER" -d "$DATABASE_NAME" < "$repository_root/tests/e2e/postgres_migration_acceptance_assignment_release_compatibility.sql"
echo "PostgreSQL Migration Acceptance Runtime E2E: M4 Assignment-release compatibility oracle PASS"
psql_in_container "$BOOTSTRAP_USER" -d "$DATABASE_NAME" < "$repository_root/tests/e2e/postgres_migration_acceptance_student_assignment_attempt_navigation.sql"
echo "PostgreSQL Migration Acceptance Runtime E2E: M5 Student Assignment Attempt navigation oracle PASS"
psql_in_container "$BOOTSTRAP_USER" -d "$DATABASE_NAME" < "$repository_root/tests/e2e/postgres_migration_acceptance_assignment_attempt_saved_responses.sql"
...
psql_in_container "$BOOTSTRAP_USER" -d "$DATABASE_NAME" < "$repository_root/tests/e2e/postgres_migration_acceptance_course_appearance_catalog.sql"

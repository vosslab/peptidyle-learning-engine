...
use super::{
    ...
    ReusableCurriculumValidationError, validate_reusable_curriculum_title,
};
...
impl ReplaceBlueprintCourseDefinitionInput {
    ...
    pub fn validate(&self) -> Result<(), ReusableCurriculumValidationError> {
        ...
        for module in &self.modules {
            ...
            {
                return Err(ReusableCurriculumValidationError::DuplicateRetainedModuleHandle);
            }
            validate_reusable_curriculum_title(&module.label)
                .map_err(|_| ReusableCurriculumValidationError::InvalidModuleLabel)?;
            if module.definitions.is_empty()
            ...
            for assignment in &module.definitions {
                ...
                {
                    return Err(
                        ReusableCurriculumValidationError::DuplicateRetainedAssignmentHandle,
                    );
                }

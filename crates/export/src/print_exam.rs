...
impl PrintExam {
    ...
    pub fn render_all(&self) -> ExportBundle {
        ExportBundle {
            docx: crate::docx::write(self, PrintLayout::Standard),
            pdf: crate::pdf::write(self, PrintLayout::Standard),
            accessible_docx: crate::docx::write(self, PrintLayout::Accessible),
            accessible_pdf: crate::pdf::write(self, PrintLayout::Accessible),
        }
    }
...
fn resolve_question_assets(
    ...
    for asset in refs {
        ...
        if !crate::pdf::png_is_supported(&resolved.bytes) {
            return Err(format!(

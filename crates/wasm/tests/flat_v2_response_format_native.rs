...
#[test]
fn flat_v2_public_response_corpus_matches_native_bridge() {
...
#[test]
fn flat_v2_public_response_calls_are_repeatable_natively() {
    let case = flat_v2_response_corpus::matching_full_permutation();

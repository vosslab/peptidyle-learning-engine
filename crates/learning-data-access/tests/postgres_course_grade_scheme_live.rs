...
use learning_data_access::{
    AssignmentEntitlementMaterialization, AssignmentRecord, CatalogStore,
    CourseGradeAssignmentMembership, CourseGradeSchemeRevision, CourseGradebookStore, CourseRecord,
    CourseRosterContact, CourseRosterId, CourseRosterStore, CreateCourseCommand, DraftRecord,
    MaterializeAssignmentEntitlementCommand, PublishDraftCommand, SessionLifetime, SessionStore,
    SessionSubject, SessionTokenHash, Store, StoreError, TenantContext, UpdateCourseGradeScheme,
    UpsertCourseMember,
};
...
use question_model::{
    ...
    AssignmentScoringMode, BackendCapabilities, Capability, CourseGradeMode,
    CourseGradeRoundingRule, CourseGradeScheme, CourseId, DraftQuestionDefinition,
    DraftQuestionSource, EntitlementPurpose, GradeCategoryId, GradeCategoryTitle,
    GradingDefinition, PointValue, ProblemId, ProblemVersionRef, PublicationScope,
    QuestionMetadata, QuestionSource, RunPolicies, TenantId, UserId, UserRole, VersionId,
    WeightedGradeCategory, WorkspaceId,
};
use sqlx::Row;
use uuid::Uuid;

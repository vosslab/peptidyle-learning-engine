...
mod tests {
    ...
    fn mixed_exact_pins_and_pool_policies_encode_without_loss() {
        ...
        let entries: Vec<AssessmentEntry> = serde_json::from_value(serde_json::json!([
            {"kind":"fixedQuestion","id":"00000000-0000-0000-0000-000000000001","questionRevisionTuple":{"questionId":question_id,"revisionNumber":2},"pointsPossible":"3.5","availability":"available","scoringRule":"normal","questionAttemptLimit":{"maxAttempts":2},"questionAttemptTimeLimit":{"kind":"limited","seconds":90,"graceSeconds":5}},

...
use question_model::{
    AssessmentAttemptId, AssessmentEntryId, AssessmentId, PublishedQuestionRevisionTuple,
    QuestionBackend, QuestionPoolEditNumber, QuestionPoolId, QuestionPoolSelectedItem,
    StudentRecordId,
};
...
#[cfg(test)]
mod tests {
    use question_model::{PublishedQuestionId, QuestionPoolEditNumber, QuestionRevisionNumber};
    use uuid::Uuid;

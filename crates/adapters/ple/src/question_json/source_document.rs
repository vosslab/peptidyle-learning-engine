...
impl PleQuestionJsonDocumentBody {
    ...
    pub(super) fn with_hotspot_surface_image(
        &self,
        question_asset: QuestionImageAssetTuple,
        ...
        surface.question_image_asset_id = question_asset.question_image_asset_id.to_string();

...
impl LocalFileIdentityProvider {
    /// Loads the operator-owned local identity configuration from a regular file.
    ...
    /// Decodes a private local identity configuration for composition tests and startup.

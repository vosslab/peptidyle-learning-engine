...
mod composition_live_demo;
mod object_storage;

pub use self::composition_live_demo::provision_local_sysadmin_totp_from_env;
use self::composition_live_demo::{
    live_demo_config_from_env, local_sysadmin_totp_store_from_env, required_env,
};
...
#[cfg(test)]
mod tests {
    use super::composition_live_demo::{
        live_demo_config_from_account_mappings, live_demo_config_from_environment_values,
    };
    use super::*;
    use crate::auth::SeededDemoPersona;

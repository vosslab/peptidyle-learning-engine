...
- Advanced automated grading through G1-W7b: immutable accepted Student input, answer-free status,
  automatic pre-result Job requeue, lease-fenced commits, durable receipts, and read-only
...
- Reordered the student presentation so assignment identity precedes instructions and progress,
  ...
  supplied.
- Preserved response secrecy across answer-free summaries, pending grading, and score publication
  through durable server-owned receipts and lease fences.
...
- Reused the accessible Question ID copy control in Instructor status views and clarified
  response redaction and selector ownership. The former Instructor grading-operation language is
  superseded; Instructors do not grade or retry Student work in PLE.

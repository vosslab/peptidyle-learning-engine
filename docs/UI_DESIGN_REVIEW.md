...
| Gradebook and roster                | Presents student names, keeps the compact summary table primary, and loads one composed run-history panel only on request. UUIDs remain internal.                                                                                                                                                                                                               | [instructor gradebook](screenshots/instructor/grading/01_instructor_gradebook.png); one-request and lazy-history tests                                                                         |
...
assignment through the answer-free student landing. It is an inspection surface, not a run. Ordinary

...
The current disposable baseline contains the 74 checked migration files from
`2026082901_principal_baseline.sql` through
`2026090901_assignment_attempt_completion_authority.sql`. The numbered range has no

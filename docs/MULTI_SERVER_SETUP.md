...
| `PLE_ACCEPTED_SUBMISSION_RECOVERY_DATABASE_URL`                                  | Deployment secret store                    | Worker only                               | Dedicated recovery login with sealed accepted-submission capability   |
| `PLE_ACCEPTED_SUBMISSION_FAST_PATH_DATABASE_URL`                                 | Deployment secret store                    | API only                                  | Dedicated fast-path login with exact accepted-submission capability   |

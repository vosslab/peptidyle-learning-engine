...
| Question assets                   | `GET /api/questions/{questionId}/revisions/{revisionNumber}/assets/{questionAssetId}`                                                                                                                                                                                                                                            | Delivers an immutable asset only after the authorized retained presentation relationship.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |

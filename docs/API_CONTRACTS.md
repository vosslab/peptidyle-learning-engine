...
| Exact Blueprint Revision  | `GET /api/course-blueprints/{blueprint_course_id}/revisions/{revision}`                                                                                                                         | Returns one immutable exact Blueprint Revision for an authorized Instructor, including after the lineage is archived.                                                                                    |
...
| Course summary and navigation | `GET /api/courses/{course}`, `GET /api/navigation/{course_instance_id}`                                                                                                                                                                                      | Returns answer-free scoped Course identity only for an active Course Member.                                                                                                                                                                                                                                                                                                                                                                                                                      |

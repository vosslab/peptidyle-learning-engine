...
| Course Banner Storage | 137 | `crates/learning-data-access/src/course_banner.rs`, `crates/learning-data-access/src/postgres/course_banner.rs` | `SessionTokenHash`, `CourseInstanceId`, `CourseBannerId` |
| Assignment Release Domain | 136 | `crates/learning-data-access/src/postgres/assignment_release.rs`, `crates/learning-data-access/src/assignment_release.rs` | `CourseInstanceId`, `AssessmentId`, `Result` |

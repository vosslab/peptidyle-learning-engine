...
PLE-owned external-tool boundary. `HUMAN_GUIDANCE.md` is the owner decision: every student action
...
### Short text, file, and external tools
...
- PLE-owned external-tool launch, readiness, submit, return, and error recovery expose native

...
That live gate exercises render, grade, cache, outage recovery, and browser
non-disclosure. It is acceptance evidence for the supported question path,
not a permanent pytest and not a claim that every PG problem is compatible.

...
| MOD-ID    | Frozen: `crates/question_model/src/identity.rs`, `lifecycle.rs`, and `catalog.rs`                                                             | `architect`    | MOD-OBJ, MOD-STO, MOD-SCHEMA, MOD-API-CAT                                                                                                                                         | n/a                                             |
...
| ID          | Contract source and state                                                                                                            | Owner          | Direct consumers                                                                                                                 | Stub while waiting                     |
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------ | -------------- | -------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------- |
| MOD-OBJ     | Frozen contract and implemented backend: `crates/objects/src/lib.rs` and `s3.rs`                                                     | `expert_coder` | MOD-ADP-WW, MOD-ADP-QTI, MOD-EXPORT, MOD-API-ASSET, MOD-RETENTION                                                                | `MemoryObjectStore`; opt-in MinIO gate |
| MOD-STO     | Frozen contract and implemented backend: `crates/store/src/lib.rs` and `postgres.rs`                                                 | `expert_coder` | MOD-SCHEMA, MOD-API-AUTH, MOD-API-CAT, MOD-API-COURSE, MOD-API-RUN, MOD-API-ASSET, MOD-WORKER, MOD-STATS, MOD-RETENTION, MOD-LTI | `MemoryStore`; opt-in PostgreSQL gate  |
| MOD-SCHEMA  | Implemented: `schemas/migrations/` and `crates/store/src/rls.rs`                                                                     | `expert_coder` | MOD-STO                                                                                                                          | n/a; opt-in fresh-database gate        |
...
| MOD-API-CAT    | Implemented authenticated routes and catalog store contract: `crates/server/src/catalog.rs`, `crates/store/src/lib.rs`, `src/api/client.ts`, and mock handlers                                                 | `expert_coder` | MOD-CLIENT                                          | `MemoryStore`, mock handler, opt-in PostgreSQL gate |
...
| MOD-API-RUN    | Implemented authenticated run, attempt, submission, and summary contracts: `crates/server/src/run.rs`, `crates/store/src/lib.rs`, `src/api/client.ts`, and mock handlers                                       | `expert_coder` | MOD-CLIENT                                          | `MemoryStore`, mock handler, opt-in PostgreSQL gate |
...
| ID               | Contract source and state                                                                                                                             | Owner       | Direct consumers                                                             | Stub while waiting                         |
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ---------------------------------------------------------------------------- | ------------------------------------------ |
| MOD-CLIENT       | Implemented typed boundary: `src/api/client.ts`, `contracts.ts`, `decoder.ts`, `decoders.ts`, `http_client.ts`, and `crates/server/src/validation.rs` | `coder`     | MOD-UI-SHELL, MOD-UI-ATTEMPT, MOD-UI-BROWSE, MOD-UI-EDITOR, MOD-UI-GRADEBOOK | `src/api/mock/handlers.ts` and `client.ts` |

...
| MOD-ADP-NAT     | Implemented algorithmic issue/reproduction/grading plus the strict PLE flat-question JSON v1 parser/compiler: `crates/adapters/native/src/lib.rs`, `generator.rs`, and `flat_question.rs`. Atomic workspace/publication persistence, instructor flat authoring, QTI-derived draft editing/publication, and the isolated native runtime are implemented.                                                                                                                                                                                                       | `expert_coder` | MOD-API-CAT, MOD-API-RUN, MOD-WORKER                                                                                             | n/a                                                            |
| MOD-ADP-WW      | Implemented bounded server-only renderer boundary: `crates/adapters/webwork/src/lib.rs`, `renderer_contract.rs`, `http_renderer.rs`, `shipped_render_rpc.rs`, and `sanitizer.rs`. The contract owns renderer request, response, identity, failure, render, and grade types; WP-RC3 uses the upstream shipped `/webwork2/render_rpc` form/JSON protocol.                                                                                                                                                                                                       | `expert_coder` | MOD-API-CAT, MOD-API-RUN, MOD-WORKER                                                                                             | recorded renderer fixtures                                     |
...
MOD-API-RUN below describes the implemented broad attempt projection and tagged
response wire. The accepted
[secure grading payload plan](active_plans/decisions/secure_question_grading_payload_plan.md)
is a pre-WP-RC5 atomic replacement: authenticated attempt ID, idempotency key,
...
| ID             | Contract source and state                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Owner          | Direct consumers                                                    | Reference/test implementation                       |
| -------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- | ------------------------------------------------------------------- | --------------------------------------------------- |
| MOD-API-AUTH   | Implemented provider-neutral route and session contracts: `crates/server/src/auth.rs`, `crates/learning-data-access/src/session.rs`; institutional OIDC is the selected production provider and WP-RC8 owns its implementation                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `expert_coder` | MOD-CLIENT, MOD-LTI                                                 | `MemoryStore` and mock auth handler                 |

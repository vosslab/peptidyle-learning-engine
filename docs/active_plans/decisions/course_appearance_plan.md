...
| Student-record retention deletes branding                 | Instructor loses reusable course identity          | Banner classified as student record                            | WS-B/WS-C      | Typed `CourseBanner` content class and archive/delete validation                        |

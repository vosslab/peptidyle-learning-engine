...
| Question variation and grades | New Assignment Attempts use `reuseQuestionsWithNewSeeds`; resumed Issued Questions retain their seed. The grade default is `highest`.                                                                                                                                                                                                                                           | WP-RC0, WP-PROF-T5, WP-PROF-G1--G5 |

...
| `2026081874_scope_bound_worker_failure.sql`              | queue failure broker     | Historical predecessor evidence for failure finalization. Its SD1-C successor derives exact course, assignment, operation, and generation scope from a locked recalculation lease.                   |

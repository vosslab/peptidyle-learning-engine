...
grants, ownership, and direct SQLx callers. It performs no backfill or compatibility alias.
...
| Current broker policy                          | Exact target policy                            |
| ---------------------------------------------- | ---------------------------------------------- |
| `learner_work_broker_assignment_tenant`        | `student_work_broker_assignment_tenant`        |
| `learner_work_broker_attempt_tenant`           | `student_work_broker_attempt_tenant`           |
| `learner_work_broker_audience_tenant`          | `student_work_broker_audience_tenant`          |
| `learner_work_broker_course_tenant`            | `student_work_broker_course_tenant`            |
| `learner_work_broker_enrollment_tenant`        | `student_work_broker_enrollment_tenant`        |
| `learner_work_broker_group_member_tenant`      | `student_work_broker_group_member_tenant`      |
| `learner_work_broker_group_tenant`             | `student_work_broker_group_tenant`             |
| `learner_work_broker_member_tenant`            | `student_work_broker_member_tenant`            |
| `learner_work_broker_question_prefetch_delete` | `student_work_broker_question_prefetch_delete` |
| `learner_work_broker_question_prefetch_select` | `student_work_broker_question_prefetch_select` |
| `learner_work_broker_run_tenant`               | `student_work_broker_run_tenant`               |
| `learner_work_broker_summary_tenant`           | `student_work_broker_summary_tenant`           |

| Current function                            | Exact target function                       |
| ------------------------------------------- | ------------------------------------------- |
| `ple_fence_learner_record_write`            | `ple_fence_student_record_write`            |

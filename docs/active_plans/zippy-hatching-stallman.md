...
- [ ] M0 documents agree; no contradictory tab set remains.
- [ ] One Instructor Assignment editing path; no dead internal link.
- [ ] Ribbon ledger regenerated and matching the catalog.
- [ ] One Student delivery lane with navigation bar, saved state, and timer.
- [ ] Student-visible text carries no Instructor noun.
...
- [ ] Question presentation owns answer-choice randomization on PLE-native Questions; backend

...
| Student preview                 | `ready`           | question and question response control rendered (same components as student) | `editor_page.tsx:691-709`                                        |
...
- **Compile-time boundary**
  - `editor_page_typecheck.ts` marks draft preview cannot satisfy Released Assignment or Published Question Presentation types.
- **Route permissions**
...
This brief is marked DONE_WITH_CONCERNS because the current visible editor is not yet a full PLE Question JSON

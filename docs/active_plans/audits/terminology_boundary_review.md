...
| Broker           | Replace as a PLE component umbrella    | Name the authorization operation, External Question Provider, or exact Job claim and lease operation.                                                                                                      |
...
`ActivityTimestamp`, External Question Provider, protected database operations,
...
Canonical PLE paths include `flat_question`, `presentation`,
...
| ------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| TERM-PATH-1 (complete)    | `crates/adapters/imathas/external_question_provider.rs`                                                              | External Question Provider is the canonical iMathAS integration boundary.                                                                                                              | Every PLE-owned iMathAS provider path and symbol names the external provider or an exact launch, exchange, render, or grade operation. Message broker remains only infrastructure that routes messages. | 2026-08-31: adapter tests, source-path inspection, and `git diff --check` pass.                                                                                                              |

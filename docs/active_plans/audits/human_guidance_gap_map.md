...
| C419 | 197                                                                                                                                                                                                                                                                                                                                                                                                                                                      | SQL PASS; backend contributor: `schemas/base_schema/course_blueprint_publication.sql` `ple_api.create_blueprint_from_course_instance` and `CourseBlueprintPublicationStore` create a distinct actor-owned Private Revision 1 from the locked reusable Course structure, exclude Student/delivery state, fork Pools with exact ordered pins, and record immutable source provenance without mutating the Course. Empty Courses and empty Assessments retain their minimal exact shapes.                                                                                                                                                                                                                                                                                                    | C6 Blueprint boundary, C7 Instance read contract, C406 published predicate, C417 create/delivery. PostgreSQL 17 actual-role proof covers denial/no-write, stale rollback, replay, source preservation, first-Adoption/student counts, and lifecycle rollback. C420 browser UI remains required for its checklist rows. | `crates/learning-data-access/tests/blueprint_course_postgres/exchange.rs` `assert_actual_role_round_trip` passed; focused Rust lower-bound and empty-shape tests also passed.                                                                                                                                                                                                                                                           |
| C420 | 34                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Source/client implemented in `src/pages/course_instance_page.tsx`: Course tools opens a compact, accessible metadata-only dialog; it pre-fills names/classification, retains failure drafts, disables its fieldset while busy, preserves an idempotency key for an uncertain retry, and opens the strict new Private Revision-1 receipt. It never retypes or mutates the source Course Instance.                                                                                                                                                                                                                                                                                                                                                                                                          | C48/C55 own editor shells. Focused Node transport/decoder, TypeScript, ESLint, and Prettier pass. Close only after the leased authenticated browser gate proves visible interaction, source preservation, first Adoption, and redirect against C419.                                                             | tests/_temp/hg_a8_c420_publish_ui_probe.py; source source_me.sh && python3 tests/_temp/hg_a8_c420_publish_ui_probe.py; lease: npx playwright test tests/_temp/hg_a8_c420_publish_ui.spec.ts; remove after browser gate.                                                                                                                                            |

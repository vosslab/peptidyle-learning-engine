...
completion, and foreign-course concealment. `PageSize` is expressly a maximum,
...
| Foreign-course concealment         | PASS    | Assignment and gradebook calls by an unaffiliated actor return `StoreError::NotFound` (`pagination_scale.rs:111-125`).                                                                                                    |

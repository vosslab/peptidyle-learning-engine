...
- `docs/LOCAL_STACK_OPERATIONS.md`: local container lifecycle, build steps, and run commands.
- `docs/LOCAL_STACK_ARCHITECTURE.md`: service necessity, state ownership, and network boundaries.

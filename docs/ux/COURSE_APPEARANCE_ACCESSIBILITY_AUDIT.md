...
| ---------------------------------------- | ------------------------------------------------------- | ------------------------------------------------------------------------------------------ | --------------------------------------------------- | ------ |
| Complete the task without a pointer      | WCAG 2.2 SC 2.1.1 Keyboard                              | Theme, file, alt, save, conflict review, remove, and cancel all have keyboard paths        | `course_appearance.spec.ts`                         | Pass   |
...
npx playwright test \
  tests/playwright/course_appearance.spec.ts \

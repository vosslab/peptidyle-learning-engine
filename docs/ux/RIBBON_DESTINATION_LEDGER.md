...
| Gradebook           | gradebook ([src/route_contract.ts](../../src/route_contract.ts))                                                  | ApiClient.getLiveDemoGradebook                                                                                                                | Registered handler: crates/server/src/live_gradebook.rs::live_gradebook_router<br>[crates/server/src/live_gradebook.rs](../../crates/server/src/live_gradebook.rs)::live_gradebook_router<br>[src/api/http_client/live_gradebook.ts](../../src/api/http_client/live_gradebook.ts)::createLiveDemoGradebookClient                                                                                                   | instructor: Available<br>student: Unavailable<br>sysadmin: Unavailable   |
...
My Question Drafts is the private Instructor Authoring Workspace task. Its M6

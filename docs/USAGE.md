...
- To switch from Instructor to Student work, sign out and select a seeded Student persona. Do not
  use Instructor **Student view** as a substitute for a graded Assignment Attempt.
...
resulting Assignment Attempt, submission, receipt, grade, and instructor Gradebook history are ordinary live
records.

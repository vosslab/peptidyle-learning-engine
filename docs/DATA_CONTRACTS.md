...
| Answer-bearing material                    | Private Draft Question Revision, adapter, or grader                                | Never                                                       | Protected database/object/provider state                                                                                                 | Refuse if unavailable, malformed, or not authorized for the backend                 | [DATA_CLASSIFICATION.md](DATA_CLASSIFICATION.md)                               |
...
| Upload responses                           | No accepted Student-upload path yet                                                | No capability, Object Address, or signed URL                | No Student-upload object is accepted                                                                                                     | **Fail closed** before submission mutation                                          | Dedicated upload contract remains future work                                  |

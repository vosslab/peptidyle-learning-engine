...
| Compact submit | **Reserved** cutover               | Attempt route, idempotency key, presentation checksum, and Question-Type-minimal answer | The Question Type and all attempt-owned context                                                        | [ASSESSMENT_PAYLOAD_DESIGN.md](ASSESSMENT_PAYLOAD_DESIGN.md) |

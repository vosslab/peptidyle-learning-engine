...
| Private Question | Replace when it means editable content | Use Draft Question. Use Question Revision only for immutable published content. Qualify exact source, grading, answer, or storage material as private only when access is the point.                       |

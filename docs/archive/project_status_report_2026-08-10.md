...
| WP-RC4 flat JSON v2                   | Implemented, acceptance open                             | Eight PLE runtime/source families exist; independent contract/security closeout remains                                                                                                                                                                                                                                     |
...
- WP-RC1, WP-RC2, QTI profile-to-PLE, course appearance, retention, forced-RLS, and object

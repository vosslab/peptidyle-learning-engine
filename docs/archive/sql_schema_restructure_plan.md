...
[schema_style_checker_plan.md](active/schema_style_checker_plan.md) shipped the
...
- Touch points: `schema_style/check_schema_style.py` and `schema_style/schema_catalog_lib.py`, which
  [schema_style_checker_plan.md](active/schema_style_checker_plan.md) ships against the current source

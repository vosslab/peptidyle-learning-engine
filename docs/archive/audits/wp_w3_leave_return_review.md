...
| Exact arranged selection          | The course and Mastery Assessment IDs use only the configured public UUID hrefs and each requires count one before Tab, focus assertion, and Enter.                                                                                                                                                                 | PASS   |

...
| Common history, 742-761: exact Question/Pool delivery pins, responses, outcomes; SHA-256 source/assets | `assessment_attempts.sql`, `assessment_attempt_presentation.sql`, `object_records.sql`, `question_images.sql` | Supported evidence structure. Object bytes and renderer reproduction remain external. |

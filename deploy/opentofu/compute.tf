...
locals {
  ...
  api_required_secret_keys = ["DATABASE_URL", "PLE_GRADER_DATABASE_URL", "PLE_WEBAUTHN_ORIGIN", "PLE_WEBAUTHN_RP_ID", "PLE_WEBAUTHN_RP_NAME", "PLE_TRUSTED_PROXY_CIDRS", "PLE_PUBLIC_ASSET_BASE_URL"]
